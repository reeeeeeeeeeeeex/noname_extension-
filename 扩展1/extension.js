    ...
    skill: {
        skill: {
            ...
            kuanglan: {
                ...
                content: function() {
                    'step 0'
                    player.chooseBool(get.prompt("kuanglan")).set('ai', function() { return true; });
                    'step 1'
                    if (result.bool) {
                    ...
                    'step 4'
                    player.storage.kuanglan_dmg = result.index + 1;
                    player.addTempSkill('kuanglan_effect', 'phaseAfter');
            ...
            "kuanglan_effect": {
                ...
                group: "kuanglan_effect_damage",
                "skill_id": "kuanglan_effect",
                "_priority": 0,
            },
            "kuanglan_effect_damage": {
                trigger: {
                    source: "damageBegin1",
                },
                forced: true,
                ...
                content: function() {
                    trigger.num += (player.storage.kuanglan_dmg || 1);
                    player.removeSkill('kuanglan_effect');
                    delete player.storage.kuanglan_dmg;
                },
                ai: {
                    damageBonus: true,
                },
                "skill_id": "kuanglan_effect_damage",
                "_priority": 0,
            },
            jielve: {
                audio: "ext:扩展1:2",
        ...
        translate: {
            ...
            kuanglan: "缮甲",
            "kuanglan_info": "每名角色的回合开始时，你可以摸2-4张牌（自选）；若此时是你的回合，你可以视为使用一张无视距离、不可响应且伤害增加1-2点（自选）的【杀】。",
            jielve: "骁锐",
            "jielve_info": "每回合限四次，当你造成伤害时，你可以先随机获得受伤目标2-4张牌（自选张数），然后令此伤害增加2-4点（自选点数）。",
            "re_dclingxi": "灵犀",
